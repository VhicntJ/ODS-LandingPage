!function (v) { 
  v.fn.floatingWhatsApp = function (e) { 
    ...
    // IE compatibility check and append button
    if ((!(0 <= (n = window.navigator.userAgent).indexOf("MSIE") || n.match(/Trident.*rv\:11\./)) || i.showOnIE) && s.append(p).appendTo(this)) {
