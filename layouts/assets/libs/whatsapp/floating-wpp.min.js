!(function (v) {
  v.fn.floatingWhatsApp = function (e) {
    ...
    if (
      ...
      var g = v(document.createElement("a")),
      ...
      var btn1 = v(document.createElement("button"))
          .text("Servicio de Ciberseguridad")
          .addClass("custom-button")
          .addClass("w-full")
          .on("click", function () {
            C("Hola, estoy interesado en el servicio de ciberseguridad");
          }),
        btn2 = v(document.createElement("button"))
          .text("Servicio de Marketing Digital")
          .addClass("custom-button")
          .addClass("w-full")
          .on("click", function () {
            C("Hola, estoy interesado en el servicio de marketing digital");
          }),
        btn3 = v(document.createElement("button"))
          .text("Servicio de Desarrollo")
          .addClass("custom-button")
          .addClass("w-full")
          .on("click", function () {
            C("Hola, estoy interesado en el servicio de desarrollo");
          });
    ...
    function applyResponsiveStyles() {
      if (window.innerWidth <= 768) {
        ...
        // Desktop styles
        this.css({ left: "auto", right: "55px" });
        l.css("right", "55px");
      }
    }

    // Apply styles on load
    applyResponsiveStyles.call(this);
    ...
    function C(message) {
      window.open("https://wa.me/" + i.phone + "?text=" + encodeURI(message));
    }
    i.zIndex && v(this).css("z-index", i.zIndex),
      "right" === i.position &&
        (this.css({ left: "auto", right: "55px" }), l.css("right", "55px"));
  };
})(jQuery);